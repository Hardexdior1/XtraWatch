  ...
  return (
    <div>
      ...
      <section className="factWrap">
        <ScrollTrigger
          ...
          <div className="figureBg">
            <p>
              You can trust our watches and quality and professionalism of our
              products{" "}
            </p>
            ...
            <div className="numbersFlex">
              <div>
                ...
                <button className="px-4 font-bold">Years of experience </button>
              </div>
              ...
              <div>
                ...
                <button className="px-4 font-bold">Expert Supports</button>
              </div>
              ...
              <div>
                ...
                <button className="px-4 font-bold">Awards Winners </button>
              </div>
              ...
              <div>
                ...
                <button className="px-4 font-bold">Happy Clients </button>
              </div>
            </div>
          </div>
        </ScrollTrigger>
      ...
      <section className="joinWrap">
        <div className="join">
          <h1>
            Join our <span>happy customers</span>{" "}
          </h1>
          <p>
        ...
        <Slider {...settings} className="slider-carrier py-8">
          <div className="slider">
            ...
            <p>
              ...
              to EVERYONE interested in fashion&tech This is simply unbelievable{" "}
            </p>
            <div className="imgAndText2 py-6">
              <div>
